...
% 
% Content: 
% - Populate the rotated values of the "raw_data_full_body.mat" from step01
% - Update and save to the same file
...
save([out_path, 'raw_data_full_body.mat'], 'all_fish');
disp("SUCCESS: raw_data_full_body.mat is updated with rotated values.")
