...
raw_data = load([abs_path, 'data_raw_head.mat']);
clean_data = load([abs_path, 'data_clean_head.mat']);
raw_body = load([abs_path, 'data_clean_body.mat']);

file = load([abs_path, 'helper_bad_tags_body.mat']);
...
save([abs_path, 'helper_bad_tags_both.mat'], 'ID');
disp("SUCCESS: helper_bad_tags_both.mat is saved.")
