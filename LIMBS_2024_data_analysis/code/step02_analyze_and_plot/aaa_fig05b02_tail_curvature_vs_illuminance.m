...
for i = 1:num_fish
    ...
    plot(lux, data_smoothed_centered * 100, '-',  'LineWidth', 2, 'Marker', 'o', 'MarkerSize', 3);
end
...
%% 4. Save to figure
saveas(gcf, [out_path,  'fig05b07_all_fish_tail_curvature_vs_illuminance.png']);
saveas(gcf, [out_pdf_path,  'fig05b07_all_fish_tail_curvature_vs_illuminance.pdf']);
