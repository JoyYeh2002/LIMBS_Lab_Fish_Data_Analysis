...
fish_name = 'Hope';
file_name = strcat(fish_name,'_TEST_HEAT_MAP_HUH.mat');
...
xlabel('Frequency in Hz','FontSize',14)
ylabel('FFT Velocity','FontSize',14)
sgtitle(['Fish:',fish_name,'Body point = ', num2str(body_point_idx), ...
    '(Tail), Diff  Colors: Diff IL, avg'],'fontsize',14)

avg_fig_out_filename = [fish_name, '_AVG_FFT.png'];
saveas(gcf, [out_path, avg_fig_out_filename]);
...
hold on
    ...
    saveas(gcf, [out_path, waterfall_fig_out_filename]);
end
