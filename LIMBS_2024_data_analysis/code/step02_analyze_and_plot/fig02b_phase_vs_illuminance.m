...
for i = 1 :num_fish
    ...
    % Do the smoothing operation here for Sigmoid fit
    % Don't smooth again during plotting
    data_smoothed = smooth([data_cell{i, :}])';
...
for i = 1 : num_fish
    ...
    fish_line = semilogx(lux, data_centered, '-', 'Color', colorMap(i, :), ...
...
[fitted_model, gof] = createSigmoidFitTrackingPhase(x, y);
...
title('All Fish Open-Loop Tracking Phase vs. Illuminance'); 
...
legend('Fish 1', 'Fish 2', 'Fish 3', 'Fish 4', 'Fish 5', ['Sigmoid: R^2 = ', num2str(gof.rsquare)], 'Location', 'southeast'); % Add legend
...
function [fitresult, gof] = createSigmoidFitTrackingPhase(x, y)
