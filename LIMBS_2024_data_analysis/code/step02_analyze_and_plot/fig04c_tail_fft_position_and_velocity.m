...
for i = 1 : 5
    ...
    % Create legend based on plot DisplayNames
    ...
    if ismember(i, sample_fish_idx)
        saveas(main_figure, [out_path, 'fig04c_tail_FFT_vs_illuminance_', fish_name, '.png']);
        saveas(main_figure, [pdf_path, 'fig04c_tail_FFT_vs_illuminance_', fish_name, '.pdf']);
    end

    disp(['SUCCESS: ', 'fig04c_tail_FFT_vs_illuminance', fish_name, ' is saved.']);
