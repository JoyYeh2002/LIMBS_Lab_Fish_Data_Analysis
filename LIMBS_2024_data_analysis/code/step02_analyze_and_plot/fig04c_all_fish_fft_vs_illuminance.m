...
out_archive_path = fullfile(parent_dir, 'figures_archive\fig04d_tail_FFT_at_peak\');
...
if plot_customized_peaks == 1
    ...
    for fish_idx = 1 :5
        ...
        target_idx_range = target_idx - 4 : target_idx + 4; % 0.05Hz each idx, so we go 2Hz above and below
